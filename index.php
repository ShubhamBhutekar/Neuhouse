...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">NeuHouse</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To One Stop Rooms</div>
          <div class="intro-heading text-uppercase"><h1>Help You Found Suitable Rooms!</h1><br></div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Search rooms or Find rooms!
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="keywords" name="keywords" type="text" placeholder="Keywords (Ex: 1 BHK, Rent, Landmark)" required data-validation-required-message="Please enter keywords">
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              echo '<a href="QR.html"><button id="" class="btn btn-success btn-md text-uppercase" name="pay" value="search" type="submit">Book now</button></a>';
    ...
    <footer style="background-color: #212529;;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h6 style="color:white;"><p class="copyright">&copy; 2023-2024 All rights reserved.</p></h6>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
            <li class="list-inline-item">
                 <a href="https://wa.me/+917620426956"  target="_blank">
                  <i class="fa fa-whatsapp"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="mailto:bhutekarshubham904@gmail.com" target="_blank">
                  <i class="fa fa-envelope icon"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="https://www.linkedin.com/in/shubham-bhutekar-0123/" target="_blank">
                  <i class="fa fa-linkedin icon"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="https://github.com/ShubhamBhutekar" target="_blank">
